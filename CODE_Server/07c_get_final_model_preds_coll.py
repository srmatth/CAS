...
sev_mod = sk.GradientBoostingRegressor(loss = "huber", n_estimators=1000, max_depth=1, learning_rate = 0.001,min_impurity_decrease=.0001, max_samples=0.632, n_jobs=-1)
